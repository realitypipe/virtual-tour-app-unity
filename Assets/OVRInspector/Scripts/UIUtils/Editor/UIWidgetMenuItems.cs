...
public class UIWidgetMenuItems : MonoBehaviour
{
    ...
    {
        CreateUIWidget("Assets/OVRInspector/Prefabs/SliderWithLabels.prefab", "New Sample Framework Slider"); 
    }

    [MenuItem ("GameObject/UI/Sample Framework Toggle Box")]
    static void CreateToggle()
    {
        CreateUIWidget("Assets/OVRInspector/Prefabs/ToggleWithLabels.prefab", "New Sample Framework Toggle"); 
    }

    [MenuItem ("GameObject/UI/Sample Framework Button")]
    static void CreateButton()
    {
        CreateUIWidget("Assets/OVRInspector/Resources/Prefabs/Button.prefab", "New Sample Framework Button"); 
    }
