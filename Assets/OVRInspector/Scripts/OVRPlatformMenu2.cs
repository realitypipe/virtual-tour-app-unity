...
/// </summary>
public class OVRPlatformMenu2 : MonoBehaviour
{
	/// <summary>
    ...
    public bool showMenuEnabled = false;
    bool showMenuEnabledAtInitialDownTime = false;
	...
	eBackButtonAction HandleBackButtonState() 
	{
		...
		if ( Input.GetKeyDown( KeyCode.Escape ) )
		{
			...
			if ( downCount == 1 )
			{
                ...
                showMenuEnabledAtInitialDownTime = showMenuEnabled;
			}
		}
		else if ( downCount > 0 )
		{
	...
	void ShowConfirmQuitMenu()
	{
		...
		Debug.Log("[PlatformUI2-ConfirmQuit] Showing @ " + Time.time);
